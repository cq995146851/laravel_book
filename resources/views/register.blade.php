    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            ...
            <div class="weui-cell__ft">
                <button class="weui-vcode-btn bk_important bk_phone_code_send">获取验证码</button>
            </div>
            <div class="weui_cell_ft">
            </div>
        </div>
...
@section('my-js')
    <script type="text/javascript">
        ...
        $('.bk_phone_code_send').click(function () {
            ...
            var timer = window.setInterval(function () {
                $('.bk_phone_code_send').html(--num + 's后 重新发送');
                if (num == 0) {
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: '/service/validate_sms/send_sms',
    ...
    <script type="text/javascript">
        ...
        function verifyPhone(phone, password, confirm, phone_code) {
            ...
            if (password != confirm) {
                layer.msg('两次密码不相同',{time:1000});
                return false;
            }
            if (phone_code == '') {
                layer.msg('手机验证码不能为空',{time:1000});
                return false;
            }
            if (phone_code.length != 6) {
                layer.msg('手机验证码为6位',{time:1000});
                return false;
            }
            return true;
        }
